  ...
  if (!p.disponible) {
    ...
    accionesEl = (
      <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
        ...
        {hint && (
          <span className={hintClass} style={{ textAlign: "center" }}>
            {hint}
          </span>
        )}
      </div>
    ...
    const aviso = maxAlc ? (
      <span className="card-stock-msg" style={{ textAlign: "center" }}>
        {p.stock === 1
          ? "¡Solo hay 1, es tuya!"
          : `¡Máx. ${p.stock} disponibles!`}
      </span>
    ...
    accionesEl = (
      ...
      >
        <div className="card-qty" style={{ gap: "12px" }}>
          ...
          <span className="card-qty-num" style={{ fontSize: "1rem" }}>
            {cant}
          </span>
          <button
            className="card-qty-btn"
      ...
      <div className="product-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="product-modal-img">
          {p.imagen ? (
            ...
            <div className="card-img-placeholder" style={{ fontSize: "5rem" }}>
              {p.emoji || "✨"}
            </div>
          )}
          {badgeEl}
...
export default function App() {
  ...
  useEffect(() => {
    document.body.style.overflow =
      cartOpen || lightbox || modalProducto ? "hidden" : "";
